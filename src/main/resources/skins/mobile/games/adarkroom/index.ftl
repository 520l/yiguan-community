...
<a class="logo" href="https://fishpi.cn" alt="一罐社区社区小游戏-作者DoubleSpeakGames.com" target="_blank" style="text-decoration: none; color: #3c4148;">
	...
	<p>反作弊已启动，将记录您的游戏时间<br>一罐社区<span style="color: #3caf36; font-weight: bold;">实时在线</span>，用户名：${currentUser.userName}</p>
</a>
