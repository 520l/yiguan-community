...
var Util = {
    ...
    insertWarnBroadcastModel: function (num) {
        ...
        switch (num) {
            case 1:
                model = '一罐社区社区即将进行升级维护，预计停服时间：<b>5分钟</b><br>' +
                    '维护完成后一罐社区将自动刷新（客户端请手动重新登录），感谢你的理解～<br>' +
                    '摸鱼这么久了，去给自己倒杯咖啡吧 ☕️';
                break;
            case 2:
                model = '一罐社区社区即将进行升级维护，预计停服时间：<b>20秒</b><br>' +
                    '维护完成后一罐社区将自动刷新（客户端请手动重新登录），感谢你的理解～<br>' +
                    '摸鱼这么久了，去给自己倒杯咖啡吧 ☕️';
                break;
        }
                ...
                if (userIntro !== "") {
                    ...
                    if (userAppRole === "0") {
                        html += '<div class="user-card__info vditor-reset">' +
                            '一罐社区 ' + userNo + ' 号成员，<b>黑客</b>' +
                            '</div>\n';
                    } else if (userAppRole === "1") {
                        html += '<div class="user-card__info vditor-reset">' +
                            '一罐社区 ' + userNo + ' 号成员，<b>画家</b>' +
                            '</div>\n';
                    }
                }
            ...
            switch (data.command) {
                ...
                case 'warnBroadcast':
                    ...
                    Util.alert("" +
                        ...
                        "<div><h1>一罐社区社区紧急公告</h1><br>" + text + "<br><br>——紧急公告发布人：" + who + "</div>" +
                        "</div>\n" +
                        "", "紧急公告");
                    Util.alert(text);
