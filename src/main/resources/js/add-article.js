...
var AddArticle = {
  ...
  confirmAdd: function (csrfToken, it) {
    if ($('.tags-input .tag .text').length === 0) {
      ...
      Swal.fire({
        html: "根据 <a href='https://fishpi.cn/article/1684378758315' target='_blank'>一罐社区发帖规范细则</a>，请对您的帖子进行自觉分类，自行选择是否获得<a target='_blank' href='https://fishpi.cn/article/1683775497629'>好帖积分和活跃度奖励</a> (300积分和45%活跃度，每日仅第一次有效)<br><br>" +
